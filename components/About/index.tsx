    ...
    <section className="h-screen bg-no-repeat">
      ...
      <div className="md:flex md:flex-row flex-col mx-4 justify-center  ">
        ...
        <div className="md:w-80 md:h-80 w-60 h-60 bg-clip-border md:m-9 my-0 mx-auto">
          <div className="absolute m-3 md:w-80 md:h-80 w-60 h-60 outline outline-offset-2 outline-indigo-400"></div>
          <Image
            src={portrait}
